            ...
            <div class="col-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="c_house_flr_area_disp" name="c_house_flr_area_disp" value="<?php echo $c_floor_area; ?>" class="form-control form-control-sm">
...
<div class="others_title" id="bottom_space" style="margin-top:1px;margin-bottom:10px;">Details on Additional Cost</div>
    ...
    <div class="rdo_buttons">
        ...
        <div class="row">
            ...
            <input type="text" value="<?php echo number_format($aircon_outlet_price,2) ?>" class="form-control form-control-sm" id="aircon_outlet_price" style="margin-bottom:10px;">
        </div>
        <div class="row">
            ...
            <input type="text" value="<?php echo number_format($aircon_grill_price,2) ?>" class="form-control form-control-sm" id="aircon_grill_price" style="margin-top:-8px;margin-bottom:10px;">
        </div>
        <div class="row">
...
<div class="ref_no" style="margin-top:-820px;width:250px;float:right;margin-right:-120px;"><b>Reference No. : </b><?php echo $ref_no; ?></div>
