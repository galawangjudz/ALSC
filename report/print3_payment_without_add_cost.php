...
<div class="card-body" id="card-payment">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-0.5" style="margin-top:-10px;">
                <div class="form-group">
    ...
    <div class="container-fluid" style="margin-top:-10px;">
        <div class="row">
            <div class="col-md-1" id="tcp_coverage">
                <label class="control-label" style="margin-top:0px;">LOT</label><br>
                <label class="control-label" style="margin-bottom:1px;">HOUSE</label><br>
                <label class="control-label" style="margin-bottom:0px;">FENCE</label><br>
            </div>
            <div class="col-md-4">
                <div class="row">
                    <div class="col-md-4">
...
<div class="ref_no" style="margin-top:-1120px;width:250px;float:right;margin-right:-120px;"><b>Reference No. : </b><?php echo $ref_no; ?></div>
<div class="card-body">
    <table>
        <tr>
        ...
        <div class="row" style="margin-top:5px;margin-bottom:-5px;">
            ...
            <div class="col-md-3" style="margin-left:-4px;margin-top:10px;">
    ...
    <div class="dp_sched">
        ...
        <div class="titles3">SALES</div>
            ...
            <table width="100%" id="tblborder">
                ...
                <tr><td class="txtSignature" style="font-weight:bold;margin-top:-5px;height:23px;line-height:10px;">Chief Operating Officer</td></tr>
            </table>     
        </div>
    </div>
</div>
