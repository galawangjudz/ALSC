...
<br><br>
<div class="card-body" id="card-payment" style="height:132px;">
    ...
    <div class="container-fluid" style="margin-top:-16px;">
        <div class="row">
            <div class="col-md-1" id="tcp_coverage">
                <label class="control-label" style="padding-top:15px;">LOT</label><br>
                <label class="control-label" style="padding-top:8px;">HOUSE</label><br>
                <label class="control-label" style="padding-top:7px;">FENCE</label><br>
            </div>
...
<div class="others_title" id="bottom_space" style="margin-top:1px;margin-bottom:10px;">Details on Additional Cost</div>
    ...
    <div class="rdo_buttons" style="margin-left:70px;margin-right:40px;">
        ...
        <div class="row" style="margin-bottom:14px;margin-top:5px;">
            <input type="hidden" value="<?php echo ($aircon_outlet_price) ?>" class="form-control form-control-sm" id="aircon_outlet_price">
            <input type="text" value="<?php echo number_format($aircon_outlet_price,2) ?>" class="form-control form-control-sm" id="aircon_outlet_price_disp">
        </div>
        <div class="row" style="margin-bottom:14px;">
            <input type="hidden" value="<?php echo ($aircon_grill_price) ?>" class="form-control form-control-sm" id="aircon_grill_price">
            <input type="text" value="<?php echo number_format($aircon_grill_price,2) ?>" class="form-control form-control-sm" id="aircon_grill_price_disp">
        </div>
        <div class="row" style="margin-bottom:14px;">
            <input type="hidden" value="<?php echo ($conv_outlet_price) ?>" class="form-control form-control-sm" id="conv_outlet_price">
            <input type="text" value="<?php echo number_format($conv_outlet_price,2) ?>" class="form-control form-control-sm" id="conv_outlet_price_disp">
        </div>
        <div class="row" style="margin-bottom:14px;">
            <input type="hidden" value="<?php echo ($service_area_price) ?>" class="form-control form-control-sm" id="service_area_price">
            <input type="text" value="<?php echo number_format($service_area_price,2) ?>" class="form-control form-control-sm" id="service_area_price_disp">
        </div>
        <div class="row" style="margin-bottom:14px;">
            <input type="hidden" value="<?php echo ($others_price) ?>" class="form-control form-control-sm" id="others_price">
            <input type="text" value="<?php echo number_format($others_price,2) ?>" class="form-control form-control-sm" id="others_price_disp">
        </div>
        <div class="row" style="margin-bottom:14px;">
...
<div class="ref_no" style="margin-top:-1635px;width:250px;float:right;margin-right:-120px;"><b>Reference No. : </b><?php echo $ref_no; ?></div>
...
<div class="card-body" id="payment_details" style="margin-top:0px;height:305px;">
    <div class="row">
    <div class="dp_sched" style="height:305px;">
            ...
            <div class="dp_container">
                ...
                <div class="row" style="margin-top:-12px;margin-bottom:-3px;">
                    <div class="col-md-12">
                ...
                <div class="row" style="margin-top:-14px;">
                    <div class="col-md-12">
                        <label class="control-label2" id="lbl_dp" style="margin-bottom:4px;">Commencing Date:</label>
                        <input type="text" value="" class="form-control form-control-sm">
                    </div>
                </div>
            </div>
        </div>
        <div class="ma" style="height:305px;">
        ...
        <div class="ma_sub"> *Based on In-House Financing pending Bank approval of Housing Loan</div>
            <div class="dp_container2">
                ...
                <div class="row">
                    <div class="col-md-5">
                        <label class="control-label2" id="lbl_dp" style="margin-top:2px;margin-bottom:4px;"> Interest Rate:</label>
                    </div>
                    <div class="col-md-7">
                        <label class="control-label2" id="lbl_dp" style="margin-top:2px;margin-bottom:4px;">Fixed Factor:</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5">
                ...
                <div class="row" style="margin-bottom:3px;">
                    <div class="col-md-12">
                        <label class="control-label2" id="lbl_dp" style="margin-top:8px;margin-bottom:5px;">Monthly Amortization:</label>
                        <input type="text" value="" class="form-control form-control-sm">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <label class="control-label2" id="lbl_dp" style="margin-top:8px;margin-bottom:4px;">Total Monthly Amortization:</label>
                        <input type="text" value="" class="form-control form-control-sm">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <label class="control-label2" id="lbl_dp" style="margin-top:6px;margin-bottom:5px;">Commencing Date:</label>
...
function printRA(){
    ...
    html2canvas:  { dpi: 300, letterRendering: true, width: 780, height: 3500, scale:2},
