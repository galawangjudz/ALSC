...
<body>
<?php $qry = $conn->query("SELECT * FROM cv_entries where id = '{$_GET['id']}' ");
...
?>
<?php $qry_supp = $conn->query("SELECT * FROm supplier_list WHERE id = '$supp_code'; ");
                ...
                <th class="report-header-cell">
                    <div class="header-info">
                        ...
                        <div class="container" style="margin-top:15px;">
                            ...
                            <tbody>
                                <?php 
                                $jitems = $conn->query("SELECT j.*,a.code as account_code, a.name as account, g.name as `group`, g.type FROM `cv_items` j inner join account_list a on j.account_id = a.id inner join group_list g on j.group_id = g.id where journal_id = '$vs_id'");
