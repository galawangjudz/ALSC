...
<div class="card card-outline rounded-0 card-maroon">
 ...
 -->                            
                                ...
                                <table style="width:100%;">
                                    <tr>
                                        <td>
                                            <button type="button" style="width:<?php echo ($c_ca_status == 3) ? '50%' : '100%'; ?>" class="btn btn-flat btn-sm btn-secondary dropdown-toggle dropdown-icon" data-toggle="dropdown" style="font-size:14px;">
                                        ...
                                        <?php if($c_ca_status == 3){ ?>
                                        <td>
                                            <a attachment-id="<?php echo $getID; ?>" class="btn btn-flat btn-sm btn-success" data-toggle="modal" id="upload_file" style="width:100%;margin-right:5px;font-size:14px;">
                                                <i class="fas fa-edit" aria-hidden="true"></i>&nbsp;&nbsp;For Revision
                                            </a>
                                        </td>
                                        <?php } ?>
                                        <td>
                                            <a href="<?php base_url ?>admin/?page=mail/mail&id=<?php echo $getID; ?>" data-csr-id="'.$row['c_csr_no'].'" data-email="'.$row['c_email'].'" data-invoice-type="'.$row['c_employment_status'].'" data-custom-email="'.$row['c_email'].'" class="btn btn-flat btn-sm btn-primary" style="width:100%;font-size:14px;">
