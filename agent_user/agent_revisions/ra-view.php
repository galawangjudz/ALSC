 ...
 -->                            
                            ...
                            <table style="width:100%;">
                                <tr>
                                    ...
                                    <?php
                                        $qry_attachments = $conn->query("SELECT * FROM tbl_attachments WHERE c_csr_no = '".$getID."'");
                                        if ($qry_attachments->num_rows > 0) {
                                            $disabled = 'disabled';
                                        } else {
                                            $disabled = '';
                                        }
                                    ...
                                    <td>
                                        <a href="<?php base_url ?>admin/?page=mail/mail&id=<?php echo $getID; ?>" data-csr-id="'.$row['c_csr_no'].'" data-email="'.$row['c_email'].'" data-invoice-type="'.$row['c_employment_status'].'" data-custom-email="'.$row['c_email'].'" class="btn btn-flat btn-sm btn-primary" style="width:100%;font-size:14px;"><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp;E-mail</a>
                                    </td>
                                </tr>
                            </table>
                            </div>
