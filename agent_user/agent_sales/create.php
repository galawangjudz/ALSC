													...
													<div class="row">
														<div class="col-md-3">		
															<div class="form-group">
																...
																<input type="text" class="form-control margin-bottom buyer-last required" id="last_name" name="last_name[]" oninput="onlyLetters()" value="<?php echo isset($customer_last_name_1) ? $customer_last_name_1 : ''; ?>">
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
														...
														<div class="col-md-2">
															<div class="form-group">
																<label class="control-label">Birthdate: </label>
																	<input type="text" class="form-control buyer-bday required datepicker" name="birth_day[]" placeholder="YYYY-MM-DD" value="<?php echo isset($birth_date) ? $birth_date : ''; ?>" maxlength="10">
															</div>
														</div>
														<div class="col-md-1">
															<div class="form-group">
																<label class="control-label">Age: </label>
																<input type="text" class="form-control margin-bottom buyer-age" name="age[]" id="age" value="<?php echo isset($customer_age) ? $customer_age : ''; ?>" readonly>
															</div>
														</div>	
														<div class="col-md-3">
															<div class="form-group">
																...
																<select required id="relationship" name="relationship[]" class="form-control required">
													...
													<div class="row">
														<div class="col-md-3">
															<div class="form-group">
																...
																<input type="text" class="form-control margin-bottom required" name="id_presented[]" value="<?php echo isset($id_presented) ? $id_presented : ''; ?>">
															</div>	
														</div>
														<div class="col-md-2">
															<div class="form-group">
														...
														<div class="col-md-2">
															<div class="form-group">
																...
																<input type="text" class="form-control margin-bottom buyer-viber" id="viber" name="viber[]" oninput="limitContactNumberLengthRes()" value="<?php echo isset($customer_viber) ? $customer_viber : ''; ?>">
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
															...
															<div class="col-md-2">
																<div class="form-group">
																	<label class="control-label">Birthdate:<div class="asterisk">*</div></label>
																		<input type="text" class="form-control buyer-bday required datepicker" id="birth_day" name="birth_day[]" placeholder="YYYY-MM-DD" value="<?php echo isset($birth_date) ? $birth_date : ''; ?>" oninput="numbersAndHypens()" maxlength="10" tabindex="8">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
						...
						<div class="panel panel-default">
								<div class="panel-heading">
									...
									<div class="lot_box_res">
										...
										<input type="text" id="type_text" name="type_text" value="<?php echo isset($csr_type) ? $csr_type : '0'; ?>">
									</div>
								</div>
							<div class="panel-body form-group form-group-sm">
								<div class="lot_box">
										...
										<div class="col-md-12">		
											<div class="form-group">
												<label class="control-label">House Model: </label>
													<select class="form-control requiredHouse" id="house_model" name= "house_model" disabled>
														<option value="None" selected >None</option>
													<?php 
														$qry = $conn->query("SELECT * FROM t_model_house ORDER BY c_acronym ASC");
														while($row = $qry->fetch_assoc()):	
													?>		
														<option value="<?php echo $row['c_model'] ?>" <?php echo isset($house_model) && $house_model == $row['c_model'] ? 'selected' : 'None' ?> ><?php echo $row["c_model"] ?></option>
													<?php endwhile; ?>
												</select>
											</div>
										</div>
								...
								<div class="payment_box" id="p1">
									<div class="col-md-12">
										<div class="form-group down-frm" id= "down_frm" >
											...
											<input type="text" class="form-control margin-bottom no-payment" name="no_payment" id="no_payment" oninput="numbersAndDecimal()" value="<?php echo isset($no_payments) ? $no_payments : 0; ?>" maxlength= "3">
                                ...
                                <table class="table3 table-bordered table-hover table-striped responsive-table" id="comm_table" style="width:100%;">
									...
									<tbody>
										...
										<?php endwhile; 
											...
											<td>
												<div class="form-group form-group-sm" style="padding-top:10px;margin-top:-35px;">
													<input type="number" class="form-control calculate agent-rate requiredRes" name="agent_rate[]" value="<?php echo isset($rate) ? $rate : 0; ?>" required>
												</div>
											</td>
											<td>
												<div class="form-group form-group-sm" style="padding-top:10px;margin-top:-35px;">
...
function validateAmount() {
    ...
    $(".requiredHouse").each(function(i, obj) {
		if(selectedModel === 'None' && typeText === '3'){
			$(this).parent().addClass("has-error");
            errorCounter++;
		}
