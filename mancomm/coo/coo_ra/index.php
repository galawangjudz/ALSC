		...
		<div class="dropdown">
			<a href="#" class="main_menu dropdown-toggle" id="ra-link" style="border-left:solid 3px white;" onclick="highlightLink('ralink')"><i class="nav-icon fas fa-list"></i>&nbsp;&nbsp;&nbsp;RAs List</a>
				<ul class="dropdown-menu" style="border-radius:0px;height:122px;">
					<li><a href="<?php echo base_url ?>employee/sales_manager/?page=sm_sales" style="margin-top:-8px;"><i class="nav-icon fas fa-clock"></i>&nbsp;&nbsp;&nbsp;Pendings</a></li>
					<li><a href="<?php echo base_url ?>employee/sales_manager/?page=sm_revision"><i class="nav-icon fa fa-pen"></i>&nbsp;&nbsp;&nbsp;Revisions</a></li>
					<li><a href="<?php echo base_url ?>employee/sales_manager/?page=sm_ra"><i class="nav-icon fas fa-thumbs-up"></i>&nbsp;&nbsp;&nbsp;Approved</a></li>
				</ul>
		</div>
					...
					?>
						...
						<td align="center" style="white-space: nowrap;">
							<div style="display: inline-block;">
								...
								<a class="dropdown-item view_data" href="./?page=coo_ra/view&id=<?php echo md5($row['c_csr_no']) ?>"><span class="fa fa-eye text-primary"></span> View</a>
							

								<?php if($row['c_reserve_status'] == 0): ?>
...
<script>
	...
	$('.extend_data').click(function(){
        uni_modal("<i class='fa fa-clock'></i> Extend Approval Time",'coo_ra/extend_approval.php?id='+$(this).attr('data-id'),"mid-small")
    })
