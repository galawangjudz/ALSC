	...
	<div class="card-body">
        ...
        <div class="container-fluid">
			...
			<colgroup>
				...
				<?php 
					$i = 1;
					if (($_settings->userdata('division') != 'MNGR' && $_settings->userdata('division') != 'SPVR') || ($_settings->userdata('user_code') == '10051') ) {
					...
					GROUP BY 
						...
						MAX(tbl_tba.status7) AS U7
					FROM tbl_tba 
					JOIN tbl_tba_approvals ON tbl_tba.req_dept = 'General Services' || tbl_tba.req_dept = 'Personnel'
						AND (
							tbl_tba.status1 = " . $_settings->userdata('user_code') . "
							OR tbl_tba.status2 = " . $_settings->userdata('user_code') . "
							OR tbl_tba.status3 = " . $_settings->userdata('user_code') . "
					...
					GROUP BY 
						...
						MAX(tbl_tba.status7) AS U7
					FROM tbl_tba 
					JOIN tbl_tba_approvals ON tbl_tba.req_dept = 'Design and Devt.' || tbl_tba.req_dept = 'Technical Planning' || tbl_tba.req_dept = 'Electrical' || tbl_tba.req_dept = 'Permits and Licenses' || tbl_tba.req_dept = 'Engineering' || tbl_tba.req_dept = 'Contracts and Doc.'
						AND (
							tbl_tba.status1 = " . $_settings->userdata('user_code') . "
							OR tbl_tba.status2 = " . $_settings->userdata('user_code') . "
							OR tbl_tba.status3 = " . $_settings->userdata('user_code') . "
