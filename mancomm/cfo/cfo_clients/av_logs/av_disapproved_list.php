...
<div class="card" id="container" style="display: flex; justify-content: center;">
	<div style="max-width: 1200px; margin: 0 auto;">
        <a href="<?php echo base_url ?>mancomm/cfo/?page=cfo_clients/av_logs/av_list" class="main_menu" style="border-left: solid 3px white;" id="pending-link" onclick="highlightLink('res-link')">
			<i class="fa fa-clock" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Pending List
        </a>
        <a href="<?php echo base_url ?>mancomm/cfo/?page=cfo_clients/av_logs/av_approved_list" class="main_menu">
        ...
        <a href="<?php echo base_url ?>mancomm/cfo/?page=cfo_clients/av_logs/av_disapproved_list" class="main_menu">
