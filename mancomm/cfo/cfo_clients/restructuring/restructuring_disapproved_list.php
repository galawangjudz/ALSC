...
<div class="card" id="container" style="display: flex; justify-content: center;">
    <div style="max-width: 1200px; margin: 0 auto;">
        <a href="<?php echo base_url ?>mancomm/cfo/?page=cfo_clients/restructuring/restructuring_list" class="main_menu" style="border-left: solid 3px white;" onclick="highlightLink('res-link')">
			<i class="fa fa-clock" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Pending List
        </a>
        <a href="<?php echo base_url ?>mancomm/cfo/?page=cfo_clients/restructuring/restructuring_approved_list" class="main_menu">
			<i class="fa fa-thumbs-up" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Approved List
		</a>
        <a href="<?php echo base_url ?>mancomm/cfo/?page=cfo_clients/restructuring/restructuring_disapproved_list" id="disapproved-link" class="main_menu">
