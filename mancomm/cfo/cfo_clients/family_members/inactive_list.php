...
<div class="card card-outline rounded-0 card-maroon">
		<div class="card-header">
			<h5 class="card-title"><b><i>Inactive Family Members List</b></i></h5>
		...
		<div class="card-body">
            ...
            <div class="container-fluid">
                <table class="table table-bordered table-stripped" id="data-table" style="text-align:center;width:100%;overflow-x:auto;">
                    ...
                    <?php 
                        $i = 1;
                            $qry = $conn->query("SELECT * FROM family_members WHERE status=2 and client_id = '{$_GET['id']}'");
                        ...
                        <td align="center">
                                ...
                                <!-- <div class="dropdown-divider"></div> -->
                                <a class="dropdown-item delete-inactive" data-id="<?php echo $row['member_id'] ?>"><span class="fa fa-trash text-danger"></span>&nbsp;&nbsp;Delete</a>
...
<script>
    ...
    $('.delete-inactive').click(function(){
        _conf("Are you sure you want to delete this information?","delete_inactive",[$(this).attr('data-id')])
    }) 

    function delete_inactive($id){
        start_loader();
        $.ajax({
            url:_base_url_+"classes/Master.php?f=delete_inactive",
            method:"POST",
            data:{id: $id},
            dataType:"json",
            error:err=>{
