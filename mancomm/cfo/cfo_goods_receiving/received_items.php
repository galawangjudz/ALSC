	...
	<div class="card-footer" id="hidden-status">
		<table style="width:100%;">
			<tr>
				...
				<td>
					<a class="btn btn-flat btn-default" style="width:100%;margin-left:5px;font-size:14px;" href="?page=cfo_goods_receiving/received_items_status"><i class="fa fa-times-circle"></i>&nbsp;&nbsp;Cancel</a>
				</td>
			</tr>
		</table>
	</div>
...
<script>
    ...
    function handleReceivedClick(element) {
        ...
        if (accountCode == 0) {
            ...
            $.ajax({
				type: 'POST',
				url: 'cfo_goods_receiving/fetch_unlinked_items.php', 
				data: {
