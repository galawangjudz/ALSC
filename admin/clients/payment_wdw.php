...
<div class="card card-outline rounded-0 card-maroon">
    ...
    <table style="width:25%;float:right;">
        ...
        <tr>  
            ...
            <td style="font-size:14px;"><input type="text" class= "form-control-sm" name="tot_amt_due" id="tot_amt_due" value="<?php echo (number_format($row_due['total_amt_paid'],2)) ? (number_format($row_due['total_amt_paid'],2)) : ''; ?>" style="width:70%;float:right;text-align:right;" disabled></td>
