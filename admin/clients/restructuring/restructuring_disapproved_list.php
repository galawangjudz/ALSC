			...
			<div class="table-responsive">
                <table class="table table-bordered table-stripped" style="text-align:center;font-size:14px;">
					...
					if($usertype=='Billing' || $usertype=='IT Admin')
					{
						...
						y.lvl3, y.lvl1, y.lvl2 FROM property_payments y INNER JOIN property_clients z ON y.property_id = z.property_id WHERE lvl1=2
					...
					elseif($usertype=='Manager' || $usertype=='IT Admin')
					{
						...
						y.amount_due, y.rebate, y.surcharge, y.interest, y.principal,
						y.remaining_balance, y.payment_count,
						y.lvl3, y.lvl1, y.lvl2 FROM property_payments y INNER JOIN property_clients z ON y.property_id = z.property_id WHERE lvl1=2 and lvl2=2
						GROUP BY y.property_id;");
					...
					elseif($usertype=='COO' || $usertype=='IT Admin'){
						...
						y.amount_due, y.rebate, y.surcharge, y.interest, y.principal,
						y.remaining_balance, y.payment_count,
						y.lvl3, y.lvl1, y.lvl2 FROM property_payments y INNER JOIN property_clients z ON y.property_id = z.property_id WHERE lvl1=2 and lvl2=2 and lvl3=2
						GROUP BY y.property_id;");
                            while($row = $qry->fetch_assoc()):   
