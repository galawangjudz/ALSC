...
<!-- <form action="<?php echo base_url ?>admin/?page=clients/test&id=<?php echo $getID ?>" method="post">
...
<form action="<?php echo base_url ?>admin/?page=clients/test&id=<?php echo $getID ?>" method="post">
    ...
    <button type="submit" name="submit">Add 1 Day</button>
</form>

<p>Previous Date: <?php echo $_SESSION['pay_date_input']; ?></p>
...
<!-- <div id="tab-5" class="tab-content" style="border:solid 1px gainsboro;">
    <form method="post" id="set-paydate">
        <label class="control-label">Pay Date: </label>
        <input type="date" name="pay_date_input" id="pay_date_input" value="<?php echo date('Y-m-d'); ?>">
        <button type="button" class="btn btn-primary set_pay_date_button" name="set_pay_date_button" id="set_pay_date_button" data-date="" data-id="<?php echo md5($property_id)  ?>"><span class="fa fa-plus"> Set Paydate </span></button> 
    </form>
</div> -->
