                            ...
                            <div class="form-group">
                              <table>
                                  <tr>
                                      ...
                                      <td style="width: 50%;"><input type="text" class= "form-control-sm" name="tot_prin2" id="tot_prin2"  style="width: 100%;" value="<?php echo isset($total_prin) ? number_format($total_prin): ''; ?>.00" disabled></td>
                                      <td style="font-size:12px; width: 50%;"><label for="tot_sur2" class="control-label" style="width: 100%;">Total Surcharge: </label></td>
                                      <td style="width: 50%;"><input type="text" class= "form-control-sm" name="tot_sur2" id="tot_sur2"  style="width: 100%;" value="<?php echo isset($total_surcharge) ? $total_surcharge : ''; ?>" disabled></td>
                                      <td style="font-size:12px; width: 50%;"><label for="tot_int2" class="control-label" style="width: 100%;">Total Interest: </label></td>
                                      <td style="width: 50%;"><input type="text" class= "form-control-sm" name="tot_int2" id="tot_int2"  style="width: 100%;" value="<?php echo isset($total_interest) ? $total_interest : ''; ?>" disabled></td>
                                      <td style="font-size:12px; width: 50%;"><label for="tot_amt_due2" class="control-label" style="width: 100%;">Total Amount Due: </label></td>
                                      <td style="width: 50%;"><input type="text" class= "form-control-sm" name="tot_amt_due2" id="tot_amt_due2"  style="width: 100%;" value="<?php echo isset($total_amt_due) ? $total_amt_due : ''; ?>" disabled></td>
                                  </tr>
                              </table>
                    </div>
                </div>
