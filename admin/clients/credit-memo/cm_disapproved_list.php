...
<div class="card" id="container" style="display: flex; justify-content: center;">
    <div class="navbar-menu" style="max-width: 1200px; margin: 0 auto;">
        ...
        <a href="<?php echo base_url ?>admin/?page=clients/credit-memo/cm_approved_list" class="main_menu">
			<i class="fa fa-thumbs-up" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Approved List
		</a>
        <a href="<?php echo base_url ?>admin/?page=clients/credit-memo/cm_disapproved_list" class="main_menu" id="disapproved-link">
		...
		<div class="container-fluid">
			<div class="table-responsive">
				<table class="table table-bordered table-stripped" style="text-align:center;font-size:13px;">
					...
					if($usertype=='Billing')
					{
						$qry = $conn->query("SELECT * FROM t_credit_memo WHERE lvl1 = 2");
                        ...
                        $qry = $conn->query("SELECT * FROM t_credit_memo WHERE lvl1 = 1 and lvl2 = 2");
						while($row = $qry->fetch_assoc()):   
						...
						<td>
							...
							<?php        
								...
								$qry = $conn->query("SELECT * FROM t_credit_memo WHERE lvl1 = 1 and lvl2 = 1 and lvl3 = 2");
								while($row = $qry->fetch_assoc()):   
								...
								//$qry = $conn->query("SELECT y.*, z.* FROM t_av_summary AS y INNER JOIN property_clients AS z ON y.property_id = z.property_id WHERE y.lvl1 = 0");
								$qry = $conn->query("SELECT * FROM t_credit_memo WHERE lvl1 = 2 or lvl2 = 2 or lvl3 = 2");
								while($row = $qry->fetch_assoc()):   
