...
<div class="card" id="container" style="display: flex; justify-content: center;">
    <div class="navbar-menu" style="max-width: 1200px; margin: 0 auto;">
        <a href="<?php echo base_url ?>admin/?page=clients/credit-memo/cm_list" class="main_menu" style="border-left: solid 3px white;" id="pending-link" onclick="highlightLink('res-link')">
