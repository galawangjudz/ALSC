<!-- <?php 
// include 'admin/agents/config.php';
if($_settings->chk_flashdata('success')): ?>
    ...
    // if(isset($_GET['id'])){
    //     $user = $conn->query("SELECT * FROM t_agents where c_code =".$_GET['c_code']);
    ...
    <div class="card card-outline rounded-0 card-maroon">
        ...
        <h3 class="card-title"><?php echo !isset($_GET['id']) ? "Add Agent" :"Edit Agent" ?></h3>
        </div>
        <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">		
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control margin-bottom required" name="c_birthplace" id="c_birthplace" value="<?php echo isset($meta['c_address_ln1']) ? $meta['c_address_ln1']: '' ?>">
                                </div>
                            </div>
                            <div class="col-md-6">		
                                <div class="form-group">
                                    <label class="control-label">Tel #: </label>
                                    <input type="text" class="form-control margin-bottom required" name="c_tel_no" id="c_tel_no" value="<?php echo isset($meta['c_address_ln1']) ? $meta['c_address_ln1']: '' ?>">
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="col-xs-4">
                            <div class="form-group">
                                ...
                                <!-- <select name='c_network' id='c_network' class="c_network form-control" tabindex="19">
                                    <?php
                                        $sql = mysqli_query($conn,"SELECT * FROM t_network ORDER BY c_network");
            ...
            <div class="card-footer">
                    <button class="btn btn-flat btn-sm btn-default bg-maroon" form="manage-agent">Save</button>
