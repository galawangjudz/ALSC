                ...
                <table class="table table-bordered table-stripped" id="data-table" style="text-align:center;">
					...
					?>
                        ...
                        <td align="center">
								...
								<a class="dropdown-item" href="<?php echo base_url ?>/admin/?page=agents_list/manage_agent&id=<?php echo $row['c_code'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
