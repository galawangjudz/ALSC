                ...
                <table class="table table-bordered table-stripped" id="data-table" style="text-align:center;">
					...
					?>
                        ...
                        <td align="center">
								...
								<a class="dropdown-item edit-agent" href="./?page=agents/dd&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
...
<script>
    ...
    $('.edit-agent').click(function(){
        uni_modal("<i class='fa fa-paint-brush'></i> Edit Agent",'agents/manage_agent.php?id='+$(this).attr('data-agent-id'),"mid-large")
    })
