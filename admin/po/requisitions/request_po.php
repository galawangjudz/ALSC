...
<div class="card card-outline card-info">
	<div class="card-header">
		<h5 class="card-title"><b><i>Purchase Request Form</b></i></h5>
	</div>
	<div class="card-body">
		<form action="" id="po-form">
			...
			<div class="row">
				...
				<div class="col-md-6 form-group">
					...
					<small><i><label style="color:red;font-weight:normal;">(Leave this blank to Automatically Generate upon saving.)</label></i></small>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6 form-group">
				...
				<div class="col-md-6 form-group">
					...
					<input type="date" class="form-control form-control-sm rounded-0" name="delivery_date" id="delivery_date" required> 
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
						...
						<tbody>
							...
							<tr class="po-item" data-id="">
								...
								<td class="align-middle p-1">
									...
									<input type="text" class="text-center w-100 border-0 item_id" value="<?php echo $row['name'] ?>"/>
								</td>
						...
						<tfoot>
							<tr class="bg-lightblue">
								...
								<!-- <tr>
									...
									<input type="number" step="any" name="discount_percentage" class="border-light text-right" value="0">
									</th>
									<th class="p-1"><input type="text" class="w-100 border-0 text-right" readonly value="0" name="discount_amount"></th>
								</tr>
								<tr>
									<th class="p-1 text-right" colspan="6">Tax Inclusive (%):
									<input type="number" step="any" name="tax_percentage" class="border-light text-right" value="0">
									</th>
									<th class="p-1"><input type="text" class="w-100 border-0 text-right" readonly value="0" name="tax_amount"></th>
								</tr>
								<tr>
	...
	<div class="card-footer">
		<table style="width:100%;">
			<tr>
				...
				<td>
					<a class="btn btn-flat btn-default" href="?page=purchase_orders" style="width:100%;margin-left:5px;font-size:14px;"><i class='fa fa-times-circle'></i>&nbsp;&nbsp;Cancel</a>
				</td>
			</tr>
		</table>
	</div>
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
						location.href = "./?page=po/goods_receiving";
