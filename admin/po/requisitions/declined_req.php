...
<div class="card card-outline card-primary">
	<div class="card-header">
		<b><i><h5 class="card-title">List of Declined Purchase Requests</b></i></h5>
	</div>
	<div class="card-body">
				...
				<thead>
					...
					<tbody>
						...
						$i = 1;
							...
							$qry = $conn->query("SELECT po.*, s.name as sname FROM `po_list` po inner join `supplier_list` s on po.supplier_id = s.id WHERE (po.department='$department') and (po.status=2 or po.status2=2 or po.status3=2) order by po.date_created DESC");
