...
<div class="card card-outline card-primary">
	<div class="card-header">
		<b><i><h5 class="card-title" id="main-title">Accounts Payable Voucher List</b></i></h5>
		<div class="card-tools">
			<a href="./?page=po/apv/manage_ap_voucher" class="btn btn-flat btn-primary" style="font-size:14px;"><span class="fas fa-plus"></span>&nbsp;&nbsp;Add New Payable Voucher</a>
		</div>
	</div>
	<div class="card-body">
