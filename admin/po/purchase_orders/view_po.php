...
<div class="card card-outline card-info">
	<div class="card-header">
        ...
        <div class="card-tools">
		    ...
		    <a class="btn btn-sm btn-flat btn-primary" href="?page=po/purchase_orders/manage_po&id=<?php echo $id ?>">Edit</a>
		    <a class="btn btn-sm btn-flat btn-default" href="?page=po/purchase_orders">Back</a>
        </div>
	</div>
