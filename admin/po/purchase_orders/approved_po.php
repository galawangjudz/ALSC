...
<div class="card" id="container">
    <div class="navbar-menu">
		<a href="<?php echo base_url ?>admin/?page=po/purchase_orders" class="main_menu" id="pending-link" style="border-left:solid 3px white;"><i class="nav-icon fas fa-clock"></i>&nbsp;&nbsp;&nbsp;Pending POs</a>
		<a href="<?php echo base_url ?>admin/?page=po/purchase_orders/approved_po" class="main_menu" id="approved-link"><i class="nav-icon fas fa-thumbs-up"></i>&nbsp;&nbsp;&nbsp;Approved POs</a>
		<a href="<?php echo base_url ?>admin/?page=po/purchase_orders/declined_po" class="main_menu" id="declined-link"><i class="nav-icon fas fa-times"></i>&nbsp;&nbsp;&nbsp;Declined POs</a>
	</div>
</div>
