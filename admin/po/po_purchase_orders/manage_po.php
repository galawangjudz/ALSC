								...
								<tfoot>
									<tr class="bg-lightblue">
										...
										<table class="table-bordered" style="width:100%;">
											<tr style="padding-right:75px;padding-left:75px;align-items: center;text-align: center;">
												<td>
		...
		<div class="card-footer">
			<table style="width:100%;">
				<tr>
					...
					<td>
						<a class="btn btn-flat btn-default" href="?page=po/po_purchase_orders/" style="width:100%;margin-left:5px;font-size:14px;"><i class='fa fa-times-circle'></i>&nbsp;&nbsp;Cancel</a>
					</td>
				</tr>
			</table>
		</div>
		...
		$.ajax({
			...
			success: function(resp) {
				if (typeof resp == 'object' && resp.status == 'success') {
					location.href = "./?page=po/po_purchase_orders";
