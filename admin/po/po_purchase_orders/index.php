	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			...
			<div class="card-tools">
				<a href="./?page=po/po_purchase_orders/manage_po" class="btn btn-flat btn-primary" style="font-size:14px;"><span class="fas fa-plus"></span>&nbsp;&nbsp;Create New Purchase Order</a>
			</div>
		</div>
		<div class="card-body">
								...
								<tr>
									...
									<td align="center">
										...
										<div class="dropdown-menu" role="menu">
											<?php 
												if ($row['fpo_status'] != '3'){?>
													<a class="dropdown-item" href="?page=po/po_purchase_orders/manage_po&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
												<?php } else{ ?>
													<a class="dropdown-item" href="?page=po/po_purchase_orders/verify_po&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
												<?php } ?>
							...
							<tbody>
								...
								<tr>
									...
									<td align="center">
										...
										<div class="dropdown-menu" role="menu">
											<a class="dropdown-item" href="?page=po/po_purchase_orders/view_po&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-primary"></span> View</a>
										</div>
									</td>
								</tr>
								<?php endwhile; ?>
...
<script>
	$(document).ready(function(){
		...
		$('.view_details').click(function(){
			uni_modal("Reservaton Details","po/po_purchase_orders/view_details.php?id="+$(this).attr('data-id'),'mid-large')
		})
