...
<div class="card card-outline rounded-0 card-blue">
	<div class="card-header">
		...
		<div class="card-tools">
				<!-- <a href="./?page=sm_sales/create" class="btn btn-flat btn-default bg-blue"><span class="fas fa-plus"></span>  Select Existing Client</a> -->
		</div>
	</div>
	<div class="card-body">
	...
	<div class="card-footer">
		<table>
			<tr>
				...
				<td>
					<a class="btn btn-flat btn-sm btn-default" href="./?page=sm_sales">Cancel</a>
				</td>
			</tr>
		</table>
	</div>
