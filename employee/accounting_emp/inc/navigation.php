              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>employee/accounting_emp/?page=po/goods_receiving/received_items_status" class="nav-link nav-gr">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>employee/accounting_emp/?page=po/suppliers/" class="nav-link nav-supplier">
                      <i class="nav-icon fas fa-truck"></i>
                        <p>
                        Suppliers List
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>employee/accounting_emp/?page=po/items/" class="nav-link nav-items">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>employee/accounting_emp/?page=groups/" class="nav-link nav-group">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>employee/accounting_emp/?page=accounts/" class="nav-link nav-acc">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>employee/accounting_emp/?page=tba/tba_list" class="nav-link nav-tba">
                      <i class="nav-icon fas fa-book"></i>
                        <p>
                        TBA List
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>employee/accounting_emp/?page=journals/gl/tran_details" class="nav-link nav-tran">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>employee/accounting_emp/?page=journals/jv/manage_jv" class="nav-link nav-jv">
                      <i class="nav-icon fas fa-book"></i>
                        <p>
                        Journal Voucher
                        </p>
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>employee/accounting_emp/?page=journals/check_list" class="nav-link nav-cl">
                      <i class="nav-icon fas fa-book"></i>
                        <p>
                        Checks List
                        </p>
                    ...
                    <div style="background-color:gainsboro;">
                      ...
                      <li class="nav-item">
                        <a href="<?php echo base_url ?>employee/accounting_emp/?page=journals/vs/m_agent_voucher" class="nav-link nav-agent">
                          <i class="nav-icon fas fa-id-card"></i>
                          <p>Agents</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="<?php echo base_url ?>employee/accounting_emp/?page=journals/vs/m_employee_voucher" class="nav-link nav-emp">
                          <i class="nav-icon fas fa-id-badge"></i>
                          <p>Employees</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="<?php echo base_url ?>employee/accounting_emp/?page=journals/vs/m_client_voucher" class="nav-link nav-client">
                      ...
                      <li class="nav-item">
                          ...
                          <ul class="nav nav-treeview">
                              <li class="nav-item">
                                  <a href="<?php echo base_url ?>employee/accounting_emp/?page=journals/vs/m_supplier_voucher" class="nav-link">
                                      <i class="nav-icon fa fa-file"></i>
                                      <p>PO</p>
                                  </a>
                              </li>
                              <li class="nav-item">
                                  <a href="<?php echo base_url ?>employee/accounting_emp/?page=journals/vs/m_nonpo_supplier_voucher" class="nav-link">
                    ...
                    <li class="nav-item">
                      <a href="<?php echo base_url ?>employee/accounting_emp/?page=journals" class="nav-link nav-journal">
