                ...
                <form action="" id="journal-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" id="ref_no" name="ref_no" class="form-control form-control-sm form-control-border rounded-0" value="<?= isset($ref_no) ? $ref_no : "" ?>" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label for="transaction_date" class="control-label">Transaction Date:</label>
                            <input type="date" id="transaction_date" name="transaction_date" class="form-control form-control-sm form-control-border rounded-0" value="<?= isset($transaction_date) ? $transaction_date : "" ?>" readonly>
                        </div>
                        <div class="col-md-6 form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control form-control-sm form-control-border rounded-0" value="<?= isset($name) ? $name : "" ?>" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label for="description" class="control-label">Particulars:</label>
                            <textarea rows="2" id="description" name="description" class="form-control form-control-sm rounded-0" readonly><?= isset($description) ? $description : "" ?></textarea>
                        </div>
                    </div>
					...
					<colgroup>
						...
						<tbody>
                            ...
                            <tr class="po-item" data-id="accname">
                                ...
                                <td class="align-middle p-1">
                                <select id="account_id" class="form-control form-control-sm form-control-border select2" disabled>
                                ...
                                <td class="debit_amount text-right" name="debit"><input type="text" class="text-right w-100 border-0 debit" name="debit[]" value="<?= $row['gtype'] == 1 ? $row['amount'] : '' ?>" readonly></td>
                                <td class="credit_amount text-right" name="credit"><input type="text" class="text-right w-100 border-0 credit" name="credit[]" value="<?= $row['gtype'] == 2 ? abs($row['amount']) : '' ?>" readonly></td>
                            </tr>
                            <?php 
                            $counter++;
                            endwhile; ?>
						...
						<tfoot>
                            <tr class="bg-gradient-secondary">
                                <tr>
									<th class="p-1 text-right" colspan="1"><span>
