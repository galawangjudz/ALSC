...
<?php require_once('inc/header.php') ?>
  ...
  <div class="modal fade" id="uni_modal" role="dialog">
    <div class="modal-dialog modal-md modal-dialog-centered d-flex align-items-center justify-content-center" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"></h5>
        </div>
        ...
        <div class="modal-footer">
          <table style="width:100%;">
            <tr>
              <td>
                <button type="button" class="btn btn-flat btn-default bg-maroon" id="submit" onclick="$('#uni_modal form').submit()" style="width:100%; margin-right:5px;font-size:14px;">
                  <i class="fa fa-save" aria-hidden="true"></i>&nbsp;&nbsp;Save
                </button>
              </td>
              <td>
                <button type="button" class="btn btn-flat btn-default" data-dismiss="modal" style="width:100%; margin-left:5px;font-size:14px;">
