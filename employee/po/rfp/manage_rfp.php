                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            if (!empty($transaction_date)) {
                                $transactionformattedDateTime = date('Y-m-d\TH:i', strtotime($transaction_date));
                            } else {
                                $transactionformattedDateTime = date('Y-m-d\TH:i');
                            }
                            ?>     
                            <input type="datetime-local" class="form-control form-control-sm rounded-0" id="transaction_date" name="transaction_date" value="<?php echo isset($transactionformattedDateTime) ? $transactionformattedDateTime : '' ?>" required readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 form-group">
