...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title"><b><i>Voucher Setups</b></i></h3>
		<div class="card-tools">
			...
			<!-- <a href="<?php echo base_url ?>admin/?page=journals/manage_journal" class="btn btn-primary btn-flat"><i class="fa fa-pen-square"></i>&nbsp;&nbsp;Add New Journal Entry</a> -->
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		...
		$('.edit_data').click(function(){
			uni_modal("Edit Voucher Setup","journals/manage_journal.php?id="+$(this).attr('data-id'),"mid-large")
		})
