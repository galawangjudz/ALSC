...
<div class="card card-outline card-primary">
    <div class="card-header">
		<h5 class="card-title"><b><i><?php echo isset($_GET['id']) ? "Update Voucher Setup Entry (Agent)": "Add New Voucher Setup Entry (Agent)" ?></b></i></h5>
	</div>
    <div class="card-body">
                                ...
                                <table style="width:100%;">
                                    <tr>
                                        ...
                                        <td style="width:50%; padding-left: 10px;"> 
                                            ...
                                            <input type="text" name="agent_id" id="agent_code" class="form-control form-control-sm form-control-border rounded-0" readonly>
                                        </td>
                                    </tr>
                                </table>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var showImageLinks = document.querySelectorAll('.show-image');

        showImageLinks.forEach(function (link) {
            link.addEventListener('click', function (event) {
                event.preventDefault();
                var imageCell = this.parentNode.nextElementSibling;
                imageCell.style.display = (imageCell.style.display === 'none') ? 'table-cell' : 'none';
            });
        });
    });
</script>
