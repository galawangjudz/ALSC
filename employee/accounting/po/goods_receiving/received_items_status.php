                            ...
                            $i = 1;
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <a class="dropdown-item" href="?page=po/goods_receiving/received_items&id=<?php echo $row['id'] ?>"><span class="fa fa-check-square text-primary"></span> Receive</a>
                                            <?php
                                                $qry_get_gr = $conn->query("SELECT g.*, o.* FROM tbl_gr_list g INNER JOIN approved_order_items o ON g.gr_id = o.gr_id WHERE g.po_id = '" . $row['id'] . "'");
                                                if ($qry_get_gr->num_rows > 0) {
                                                    echo "<div class='dropdown-divider'></div>";
...
<script>
	$(document).ready(function(){
        $('.gr-list').click(function(){
            uni_modal_right("GR List",'po/goods_receiving/gr_list.php?id='+$(this).attr('gr-id'),"mid-large")
        })
