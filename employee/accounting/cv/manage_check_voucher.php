        ...
        <div class="container-fluid" style="height:auto;width:auto;">
            <div class="container-fluid" id="custom-container">
                <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                        <label for="check_date">Due Date: <span class="po_err_msg text-danger"></span></label>
                        <?php
                        if (!empty($check_date)) {
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" class="form-control form-control-sm form-control-border rounded-0" id="ref_no" name="ref_no" value="<?php echo isset($ref_no) ? $ref_no : '' ?>">
                    </div>
                </div>
            </div>
            <br>
                ...
                <div class="container-fluid" id="custom-container">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" id="check_name" name="check_name" class="form-control form-control-sm form-control-border rounded-0" value="<?php echo isset($check_name) ? $check_name : '' ?>" required><br>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 form-group">
