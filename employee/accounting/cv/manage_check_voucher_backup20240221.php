                            ...
                            <div class="card-footer">
                                <table style="width:100%;">
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-flat btn-default bg-maroon" style="width:100%;margin-right:5px;font-size:14px;" id="save_journal"><i class='fa fa-save'></i>&nbsp;&nbsp;Save & Print</button>
                                        </td>
                                        <td>
