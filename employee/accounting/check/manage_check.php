...
<style>
    ...
    <table id="check-details-table" class="table table-bordered table-stripped">
        ...
        <?php
        $query = "SELECT b.c_status, b.check_num, b.check_date, b.amount, a.check_name FROM check_details b LEFT JOIN cv_entries a ON b.c_num = a.c_num WHERE b.c_num = {$_GET['id']}";
    ...
    <?php 
        ...
        $qry = $conn->query("SELECT a.check_name, a.check_date, c.amount FROM cv_entries a LEFT JOIN check_details b ON a.c_num = b.c_num 
        LEFT JOIN cv_items c ON a.c_num = c.journal_id LEFT JOIN account_list d ON c.account_id = d.code WHERE a.c_num = '{$_GET['id']}' and d.name = 'Accounts Payable Trade';");
    ...
    ?>
        ...
        <table class="table table-bordered table-stripped">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="amount" id="amount" class="form-control rounded-0" value="<?php echo $row['amount'] ?>" required>
                </td>   
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="date" name="check_date" id="check_date" class="form-control rounded-0" value="<?php echo $row['check_date'] ?>" required>
                </td>   
            </tr>
        </table>
        <?php endwhile; ?>
