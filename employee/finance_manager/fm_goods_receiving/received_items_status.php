                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <a class="dropdown-item" href="?page=fm_goods_receiving/received_items&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-primary"></span> View</a>
                                            <?php
...
<script>
	$(document).ready(function(){
        $('.gr-list').click(function(){
            uni_modal_right("GR List",'fm_goods_receiving/gr_list.php?id='+$(this).attr('gr-id'),"mid-large")
        })
