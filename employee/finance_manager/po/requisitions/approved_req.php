...
<div class="card" id="container">
    <div class="navbar-menu">
		<a href="<?php echo base_url ?>admin/?page=po/requisitions/pending_req" class="main_menu" id="pending-link" style="border-left:solid 3px white;">&nbsp;&nbsp;&nbsp;Pending Requests</a>
		<a href="<?php echo base_url ?>admin/?page=po/goods_receiving" class="main_menu" id="approved-link">&nbsp;&nbsp;&nbsp;Approved Requests</a>
		<a href="<?php echo base_url ?>admin/?page=po/purchase_orders/declined_po" class="main_menu" id="declined-link">&nbsp;&nbsp;&nbsp;Declined POs</a>
	</div>
</div>
<div class="card card-outline card-primary">
	<div class="card-header">
		<b><i><h5 class="card-title">List of Outstanding Purchase Orders</b></i></h5>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		...
		$('.view_details').click(function(){
			uni_modal("Reservaton Details","po/requisitions/view_req.php?id="+$(this).attr('data-id'),'mid-large')
		})
