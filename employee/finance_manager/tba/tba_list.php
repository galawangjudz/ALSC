        ...
        <div class="container-fluid">
			...
			<colgroup>
				...
				<?php 
					...
					// 	$qry = $conn->query("SELECT DISTINCT tbl_tba.id, tbl_tba.tba_no, tbl_tba.preparer,tbl_tba.acc_person,tbl_tba.req_dept,tbl_tba.bank_name,tbl_tba.date_needed,tbl_tba.transaction_date,tbl_tba.payment_form, 
					...
					// } else {
						...
						tbl_tba.status1 AS U1,tbl_tba.status2 AS U2, tbl_tba.status3 AS U3, tbl_tba.status4 AS U4, tbl_tba.status5 AS U5,tbl_tba.status6 AS U6,tbl_tba.status7 AS U7 FROM tbl_tba WHERE req_dept = 'Accounting' or req_dept = 'Billing' or req_dept = 'Audit' or req_dept = 'CALS' or req_dept = 'Purchasing' or req_dept = 'Repair and Maintenance' or req_dept = 'Executive' ORDER BY tbl_tba.transaction_date DESC");
					} else {
