                    ...
                    <div class="col-md-12">
                        ...
                        <table style="width:100%;">
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-flat btn-default" href="./?page=ca_sales/ca_list" style="width:100%;margin-left:5px;font-size:14px;"><i class="fas fa-times-circle"></i>&nbsp;&nbsp;Cancel</a>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(typeof resp =='object' && resp.status == 'success'){
                        var nw = window.open("./print.php?id="+resp.id,"_blank","width=700,height=500")
							setTimeout(()=>{
								nw.print()
								setTimeout(()=>{
									nw.close()
									end_loader();
									location.replace('./?page=ca-view&id='+resp.id_encrypt)
								},500)
							},500)
