					...
					$i = 1;
						...
						if ($type < 5 ){
							...
							$qry = $conn->query("SELECT * FROM t_approval_csr i inner join t_csr_view x on i.c_csr_no = x.c_csr_no 
												WHERE c_ca_status=1 ORDER BY c_date_approved DESC");
						}else{
							$qry = $conn->query("SELECT * FROM t_approval_csr i inner join t_csr_view x on i.c_csr_no = x.c_csr_no 
												WHERE c_ca_status=1 and ".$where." ORDER BY c_date_approved DESC");
						}
					...
					?>
						...
						<td align="center" style="white-space: nowrap;">
							<div style="display: inline-block;">
								...
								<a class="dropdown-item view_data" href="./?page=ca_ra/view&id=<?php echo md5($row['c_csr_no']) ?>"><span class="fa fa-eye text-primary"></span> View</a>
