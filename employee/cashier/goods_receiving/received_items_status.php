                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                            <a class="dropdown-item" href="?page=pom_goods_receiving/received_items&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-primary"></span> Receive</a>
                                            <?php
...
<script>
	$(document).ready(function(){
        $('.gr-list').click(function(){
            uni_modal_right("GR List",'goods_receiving/gr_list.php?id='+$(this).attr('gr-id'),"mid-large")
        })
