...
<div class="card" id="container" style="display: flex; justify-content: center;">
    <div style="max-width: 1200px; margin: 0 auto;">
        <a href="<?php echo base_url ?>employee/billing/?page=clients/av_logs/av_list" class="main_menu" style="border-left: solid 3px white;" onclick="highlightLink('res-link')">
			<i class="fa fa-clock" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Pending List
        </a>
        <a href="<?php echo base_url ?>employee/billing/?page=clients/av_logs/av_approved_list" class="main_menu" id="approved-link">
			<i class="fa fa-thumbs-up" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Approved List
		</a>
        <?php if ($usertype != "CHIEF FINANCE OFFICER"){ ?>
        <a href="<?php echo base_url ?>employee/billing/?page=clients/av_logs/av_disapproved_list" class="main_menu">
