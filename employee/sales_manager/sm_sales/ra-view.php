	...
	<div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php
                    $qry0 = $conn->query("SELECT * FROM tbl_attachments WHERE c_csr_no = '" . $getID . "' and approval_status != '0'");
                    if ($qry0->num_rows > 0) {
                        echo '<table style="width:100%;">';
                        echo '<tr>';
                        if ($verify == 0) {
                            echo '<td style="width:25%;">';
                            echo '<a href="?page=sm_sales/create&id=' . md5($getID) . '" class="btn btn-flat btn-primary" style="font-size:14px; width:100%; margin-top:5px;"><i class="fa fa-edit" aria-hidden="true"></i>&nbsp;&nbsp;Edit</a>';
                            echo '</td>';
                        }
                        echo '<td style="width:50%;">';
                        echo '<button type="button" class="btn btn-flat btn-secondary dropdown-toggle dropdown-icon" data-toggle="dropdown" style="margin-top:5px; font-size:14px; width:100%;"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;&nbsp;Print<span class="sr-only">Toggle Dropdown</span></button>';
                        echo '<div class="dropdown-menu" role="menu">';
                        echo '<a class="dropdown-item" style="font-size:14px;" href="/ALSC/report/print_ra.php?id=' . $getID . '">Print Front Page</a>';
                        echo '<div class="dropdown-divider"></div>';
                        echo '<a class "dropdown-item" style="font-size:14px;" href="/ALSC/report/print_ra_back.php?id=' . $getID . '">Print Back Page</a>';
                        echo '<div class="dropdown-divider"></div>';
                        echo '<a class="dropdown-item" style="font-size:14px;" href="/ALSC/report/print_agreement.php?id=' . $getID . '">Print Agreement Page</a>';
                        echo '</div>';
                        echo '</td>';
                        if ($verify == 0) {
                            echo '<td style="width:25%;">';
                            echo '<button type="button" csr-id="' . $getID . '" csr-lot-lid="' . $lot_id . '" value="1" user-type="' . $type . '" class="btn btn-flat btn-success sm-verification" style="margin-top:5px; font-size:14px; width:100%;"><span class="fa fa-check" aria-hidden="true"></span>&nbsp;&nbsp;Verify</button>';
                            echo '</td>';
                            echo '<td style="width:25%;">';
                            echo '<button type="button" csr-id="' . $getID . '" csr-lot-lid="' . $lot_id . '" value="2" user-type="' . $type . '" class="btn btn-flat btn-danger sm-verification2" style="margin-top:5px; font-size:14px; width:100%;"><span class="fa fa-times-circle" aria-hidden="true"></span>&nbsp;&nbsp;Void</button>';
                            echo '</td>';
                        }
                        echo '</tr>';
                        echo '</table>';
