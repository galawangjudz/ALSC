        ...
        <div class="card-footer">
                <table style="width:100%;">
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-flat btn-default"  href="#" onclick="window.history.back();" style="width:100%;margin-left:5px;font-size:14px;"><i class='fa fa-times-circle'></i>&nbsp;&nbsp;Cancel</a>
                        </td>
                    </tr>
                </table>
            </div>
