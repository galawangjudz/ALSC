	...
	<div class="card-body">
        ...
        <div class="container-fluid">
			...
			<!-- <colgroup>
				...
				<?php 
					$i = 1;
					if (($_settings->userdata('type') > 4) || (($_settings->userdata('type') == 3) && ($_settings->userdata('department') == 'Marketing') || ($_settings->userdata('department') == 'Corporate Communications') || ($_settings->userdata('department') == 'General Services') || ($_settings->userdata('department') == 'Const. and Impln.') || ($_settings->userdata('department') == 'Documentation and Loan') || ($_settings->userdata('department') == 'Legal') || ($_settings->userdata('department') == 'IT') || ($_settings->userdata('department') == 'Audit') || ($_settings->userdata('department') == 'Personnel') || ($_settings->userdata('department') == 'Project Admin') || ($_settings->userdata('department') == 'Technical Planning') || ($_settings->userdata('department') == 'Permits and Licenses') || ($_settings->userdata('department') == 'Electrical'))) { 
					...
					} else if ( (($_settings->userdata('type') == 3) && ($_settings->userdata('department') == 'Executive'))) { 
						$qry = $conn->query("SELECT DISTINCT tbl_tba.amount,tbl_tba.id, tbl_tba.tba_no, tbl_tba.preparer,tbl_tba.acc_person,tbl_tba.req_dept,tbl_tba.date_needed,tbl_tba.transaction_date,tbl_tba.payment_form, 
						tbl_tba.status1 AS U1,tbl_tba.status2 AS U2, tbl_tba.status3 AS U3, tbl_tba.status4 AS U4, tbl_tba.status5 AS U5,tbl_tba.status6 AS U6,tbl_tba.status7 AS U7 FROM tbl_tba WHERE req_dept = 'General Services' || req_dept = 'Personnel' || req_dept = 'Executive' ORDER BY tbl_tba.transaction_date DESC");
					...
					FROM tbl_tba 
					JOIN tbl_tba_approvals ON tbl_tba.req_dept = 'Documentation and Loan' || tbl_tba.req_dept = 'Inventory Control' || tbl_tba.req_dept = 'Permits and Licenses'
						AND (
					...
					GROUP BY 
						...
						MAX(tbl_tba.status7) AS U7
					FROM tbl_tba 
					JOIN tbl_tba_approvals ON tbl_tba.req_dept = 'General Services' || tbl_tba.req_dept = 'Personnel' || tbl_tba.req_dept = 'Executive'
						AND (
							tbl_tba.status1 = " . $_settings->userdata('user_code') . "
							OR tbl_tba.status2 = " . $_settings->userdata('user_code') . "
							OR tbl_tba.status3 = " . $_settings->userdata('user_code') . "
					...
					GROUP BY 
						...
						tbl_tba.status1 AS U1,tbl_tba.status2 AS U2, tbl_tba.status3 AS U3, tbl_tba.status4 AS U4, tbl_tba.status5 AS U5,tbl_tba.status6 AS U6,tbl_tba.status7 AS U7 FROM tbl_tba WHERE req_dept = 'Design and Devt.' || tbl_tba.req_dept = 'Technical Planning' || tbl_tba.req_dept = 'Electrical' || tbl_tba.req_dept = 'Permits and Licenses' || tbl_tba.req_dept = 'Engineering' || tbl_tba.req_dept = 'Contracts and Doc.' ORDER BY tbl_tba.transaction_date DESC");
					}else {
						$qry = $conn->query("SELECT 
						tbl_tba.id, 
						tbl_tba.amount,
							...
							<td align="center">
								<?php 
									...
									while ($row_approved = $qry_approved->fetch_assoc()):
										...
										<?php endif; ?>
										<?php 
											if (($type > 4) || (($type == 3) && ($_settings->userdata('department') == 'Marketing') || ($_settings->userdata('department') == 'Corporate Communications') || ($_settings->userdata('department') == 'General Services') || ($_settings->userdata('department') == 'Const. and Impln.') || ($_settings->userdata('department') == 'Documentation and Loan') || ($_settings->userdata('department') == 'Inventory Control') || ($_settings->userdata('department') == 'Legal') || ($_settings->userdata('department') == 'IT') || ($_settings->userdata('department') == 'Audit') || ($_settings->userdata('department') == 'Personnel') || ($_settings->userdata('department') == 'Project Admin') || ($_settings->userdata('department') == 'Executive') || ($_settings->userdata('department') == 'Technical Planning') || ($_settings->userdata('department') == 'Permits and Licenses') || ($_settings->userdata('department') == 'Electrical') || ($_settings->userdata('department') == 'Billing') || ($_settings->userdata('department') == 'Contracts and Doc.'))) {  
