                ...
                <script>
                    document.getElementById('setApproversButton').addEventListener('click', function () {
                        ...
                        document.querySelectorAll('.custom-select').forEach(function (select, index) {
                            ...
                            if (section === 'Executive' && code == '10070') {
                                if (index === (inputValue - 2)) {
                                select.value = '20124';
                                }
                                if (index === (inputValue - 1)) {
                            ...
                            if (section === 'Executive' && code != '10070' && code != '10041') {
                                if (index === (inputValue - 3)) {
                                    select.value = '10070';
                                }
                                if (index === (inputValue - 2)) {
...
if (isset($_GET['id']) == ''){ 
    ...
    echo '} else if (section === "Executive" && code != "10070" && code != "10041") {';
    echo '    inputValue = 3; '; 
    echo '    var selects = ["10070","20124", "10055"];';
    echo '} else if (section === "Executive" && code == "10070") {';
    echo '    inputValue = 2; '; 
    echo '    var selects = ["20124", "10055"];';
