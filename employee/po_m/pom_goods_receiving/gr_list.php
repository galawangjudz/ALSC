...
<script>
    $(document).ready(function(){
		$('.gl_data').click(function() {
			...
			var redirectUrl = '?page=pom_goods_receiving/gl_trans&id=' + dataId;
...
$('.view_gr').click(function(){
    ...
    uni_modal_right("<i class='fa fa-info'></i> GR Details", 'pom_goods_receiving/view_gr_details.php?id=' + grId + '&po_id=' + poId, "mid-large");
});
