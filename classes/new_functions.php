...
document.addEventListener("DOMContentLoaded", function () {
    var radioButtonsFlrElev = document.querySelectorAll('input[type="radio"][name="chkOption4"]');
    var flrelevText = document.getElementById("flrelev_text");

    radioButtonsFlrElev.forEach(function (radio) {
        radio.addEventListener("change", function () {

            flrelevText.value = this.value;
        });
    });
});
